...
public class Ball 
{
	...
	public void modifyXPosition(double x){
		this.xPosition+=x;
	}

	public void modifyYPosition(double y){
		this.yPosition+=y;
	}
	 ...
	 */
	public void goTo(double xTarget,double yTarget,int time)
	{
		double xDisplacement=xTarget-this.xPosition;
		double yDisplacement=yTarget-this.yPosition;
		double sleep=time/Math.abs(xDisplacement);
		while (this.xPosition!=xTarget){
			modifyXPosition(xDisplacement/Math.abs(xDisplacement));
			modifyYPosition(yDisplacement/Math.abs(xDisplacement));
			Utils.sleep(sleep);
		}
	}
